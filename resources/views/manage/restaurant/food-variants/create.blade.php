...
@section('title', 'Add Food Variant - Zomato Partner')
    ...
    <div class="main-content">
        <div class="card stretch stretch-full border-0 shadow-sm rounded-3">
            <div class="card-body p-4">
                <form action="{{ route('restaurant.food-variants.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="food_id" id="food_id" class="form-select @error('food_id') is-invalid @enderror" required>
                                ...
                                @foreach($foods as $food)
                                    <option value="{{ $food->id }}" {{ old('food_id', $selectedFoodId) == $food->id ? 'selected' : '' }}>{{ $food->name }}</option>
                                @endforeach
                            </select>
