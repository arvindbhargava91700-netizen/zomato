...
@section('title', 'Food Category Details - Zomato Partner')
...
<div class="nxl-content">
    ...
    <div class="page-header">
        ...
        <div class="page-header-right ms-auto d-flex align-items-center gap-2">
            <a href="{{ route('restaurant.food-categories.edit', $foodCategory->id) }}" class="btn btn-primary fw-semibold">
    ...
    <div class="main-content">
        <div class="card stretch stretch-full border-0 shadow-sm rounded-3">
            <div class="card-body p-4">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <h6 class="fw-bold text-dark mb-3"><i class="feather-home me-2 text-danger"></i>Restaurant Details</h6>
                        <div class="p-3 bg-light rounded-3">
                            <span class="text-muted d-block fs-12">Restaurant Name</span>
