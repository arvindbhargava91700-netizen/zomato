...
<head>
    ...
    <title>Restaurant Owner Login - Zomato</title>
    <!-- Bootstrap 5 CSS -->
                ...
                <div class="card login-card p-4 mx-auto">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <h2 class="brand-title h3 mb-1">Zomato Partner</h2>
                            <p class="text-muted small">Sign in to your Restaurant Owner Panel</p>
                        </div>
                        ...
                        <form action="{{ route('restaurant.login.submit') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required autofocus placeholder="owner@restaurant.com">
                                @error('email')
                            ...
                            <div class="mb-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('restaurant.forgot_password') }}" class="text-decoration-none small text-danger">Forgot Password?</a>
                                </div>
