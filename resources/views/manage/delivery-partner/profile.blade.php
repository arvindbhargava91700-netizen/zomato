...
@section('title', 'Profile - Delivery Partner Dashboard')
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                <div class="card stretch stretch-full border-0 shadow-sm rounded-3">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('delivery-partner.profile.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="d-flex align-items-center gap-3 mb-4">
                                @if($partner && $partner->profile_image)
                                    <img src="{{ asset($partner->profile_image) }}" alt="Profile Image" class="rounded-circle border" style="width: 80px; height: 80px; object-fit: cover;">
                                @else
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" id="email" class="form-control bg-light" value="{{ $partner->email }}" disabled readonly>
            ...
            <div class="col-lg-5">
                <div class="card stretch stretch-full border-0 shadow-sm rounded-3">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('delivery-partner.password.update') }}" method="POST">
                            @csrf
