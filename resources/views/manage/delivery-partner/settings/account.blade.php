...
@section('title', 'Account & Bank Settings - Delivery Partner')
...
<div class="nxl-content">
    ...
    <div class="page-header d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="page-header-right">
            <a href="{{ route('delivery-partner.withdrawals.index') }}" class="btn btn-sm btn-outline-primary rounded-3 px-3">
    ...
    <div class="main-content">
        ...
        <form id="deliveryPartnerAccountSettingsForm" action="{{ route('delivery-partner.account.settings.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card settings-card bg-white mb-4">
                        <div class="card-header bg-white border-bottom py-3 px-4 d-flex align-items-center justify-content-between">
                            ...
                            <span class="badge bg-light text-muted border">Rider Details</span>
                        </div>
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label for="name" class="form-label fs-12 fw-bold text-muted text-uppercase mb-1">Full Name <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $user->email) }}" placeholder="partner@example.com" required>
                                    @error('email') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                                <div class="col-md-6">
                                    <label for="phone" class="form-label fs-12 fw-bold text-muted text-uppercase mb-1">Mobile / Phone Number</label>
                                    <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', $user->phone ?? '') }}" placeholder="e.g. 9876543210">
                                    @error('phone') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fs-12 fw-bold text-muted text-uppercase mb-1">KYC Status</label>
                                    <input type="text" class="form-control bg-light text-muted text-capitalize" value="{{ $user->kyc_status ?? ($user->has_pending_kyc ? 'Pending' : 'Not Submitted') }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="p-3 bank-badge mb-4 d-flex align-items-start gap-3">
                                ...
                                <div class="fs-12 text-dark">
                                    <strong>Official Payout Account:</strong> All delivery earnings and withdrawals will be disbursed directly to these bank / UPI details. Please ensure your IFSC code and Account Number are exact.
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="holder_name" id="holder_name" class="form-control @error('holder_name') is-invalid @enderror"
                                               value="{{ old('holder_name', $user->name) }}"
                    ...
                    <div class="card settings-card bg-white mb-4">
                        <div class="card-header bg-white border-bottom py-3 px-4 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <div class="rounded-circle bg-soft-warning text-warning d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;">
                                    <i class="feather-lock fs-16"></i>
                                </div>
                                <h6 class="card-title mb-0 fw-bold fs-15 text-dark">Login Security</h6>
                            </div>
                            <span class="badge bg-light text-muted border">Change Password</span>
                        </div>
                        <div class="card-body p-4">
                            <p class="fs-12 text-muted mb-4">For your security, update your password regularly. Password is required to save any changes.</p>
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <label for="password" class="form-label fs-12 fw-bold text-muted text-uppercase mb-1">Current Password <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <label for="new_password" class="form-label fs-12 fw-bold text-muted text-uppercase mb-1">New Password <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <label for="password_confirmation" class="form-label fs-12 fw-bold text-muted text-uppercase mb-1">Confirm New Password <span class="text-danger">*</span></label>
                                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Confirm new password" required>
                    ...
                    <div class="d-flex justify-content-end gap-3 mb-5">
                        <a href="{{ route('delivery-partner.dashboard') }}" class="btn btn-light border px-4 py-2 fw-semibold">
                            Cancel
                        </a>
                ...
                <!-- Right Column: Quick Guidance & Withdrawal Shortcut -->
                <div class="col-lg-4">
                    <!-- Guidelines Card -->
                    <div class="card settings-card bg-white p-4 mb-4">
                        ...
                        <ul class="list-unstyled mb-0 fs-12 text-muted d-flex flex-column gap-2">
                            ...
                            <li class="d-flex align-items-start gap-2">
                                <i class="feather-check text-success mt-1"></i>
                                <span>Your delivery earnings are settled to this account after every completed delivery.</span>
                            </li>
                            <li class="d-flex align-items-start gap-2">
                                <i class="feather-check text-success mt-1"></i>
                    ...
                    <div class="card settings-card bg-soft-primary border-primary p-4">
                        ...
                        <p class="fs-12 text-muted mb-3">Once you have updated and saved your bank details, you can request your delivery earnings payouts directly to your bank account anytime.</p>
                        <a href="{{ route('delivery-partner.withdrawals.create') }}" class="btn btn-primary w-100 fw-semibold rounded-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const form = document.getElementById('deliveryPartnerAccountSettingsForm');
