...
@section('title', 'Account Settings - Delivery Partner Dashboard')
...
<div class="nxl-content">
    ...
    <div class="main-content">
        ...
        <form action="{{ route('delivery-partner.account.settings.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', auth()->user()->name) }}" placeholder="e.g. John Doe">
                            @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label fw-semibold">Email Address</label>
                            <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', auth()->user()->email) }}" placeholder="john@example.com">
            ...
            <div class="card stretch stretch-full border-0 shadow-sm rounded-3 mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-end gap-2 mb-4">
                        <button type="submit" class="btn btn-primary px-4 fw-semibold">Update Account</button>
