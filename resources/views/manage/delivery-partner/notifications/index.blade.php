...
@section('title', 'Notifications - Delivery Partner')
    ...
    <div class="main-content">
        ...
        <div class="card stretch stretch-full">
            <div class="card-header border-bottom py-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
                ...
                <form method="POST" action="{{ route('delivery-partner.notifications.read-all') }}">
                    @csrf
            ...
            <div class="card-body p-0">
                @forelse($notifications as $notification)
                    ...
                    @endphp
                    <a href="{{ route('delivery-partner.notifications.show', $notification->id) }}"
