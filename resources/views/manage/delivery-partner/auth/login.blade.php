...
<head>
    ...
    <title>Delivery Partner Login - Zomato</title>
    <!-- Bootstrap 5 CSS -->
                ...
                <div class="card login-card p-4 mx-auto">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <h2 class="brand-title h3 mb-1">Zomato Delivery</h2>
                            <p class="text-muted small">Sign in to your Delivery Partner Panel</p>
                        </div>
                        ...
                        <form action="{{ route('delivery-partner.login.submit') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required autofocus placeholder="partner@delivery.com">
                                @error('email')
