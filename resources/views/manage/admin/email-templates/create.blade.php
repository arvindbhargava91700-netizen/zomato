...
@section('title', 'Add Email Template - Admin Dashboard')
...
<div class="nxl-content">
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Add Email Template</h5>
            </div>
            <ul class="breadcrumb">
    ...
    <div class="main-content">
        ...
        <div class="card stretch stretch-full border-0 shadow-sm rounded-3">
            ...
            <div class="card-body">
                <form action="{{ route('admin.email-templates.store') }}" method="POST" class="row g-3">
                    @csrf

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Template Name <span class="text-danger">*</span></label>
                        <input type="text" name="name" class="form-control" placeholder="Order Confirmation" value="{{ old('name') }}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Slug <span class="text-danger">*</span></label>
                        <input type="text" name="slug" class="form-control" placeholder="order_confirmation" value="{{ old('slug') }}" required>
                        <small class="text-muted">Machine name used in code, e.g. <code>order_confirmation</code>. Auto-formatted.</small>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Subject <span class="text-danger">*</span></label>
                        <input type="text" name="subject" class="form-control" placeholder="Your order #@{{ order_id }} is confirmed" value="{{ old('subject') }}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Category</label>
                        <input type="text" name="category" class="form-control" placeholder="order / auth / marketing" value="{{ old('category') }}">
                    </div>
                    <div class="col-12">
                        <label class="form-label fw-semibold">Email Body (HTML) <span class="text-danger">*</span></label>
                        <textarea name="body" id="body-input" class="d-none">{{ old('body') }}</textarea>
