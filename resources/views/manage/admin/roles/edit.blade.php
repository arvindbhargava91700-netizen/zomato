...
@section('title', getPageTitle('Edit Role'))
...
<div class="nxl-content">
    ...
    <div class="main-content">
        ...
        @php
            ...
            $roleSelectedCount = count($rolePermissions);
            $selectedPermCount = count(old('permissions', $rolePermissions));
        ...
        <div class="role-hero mb-4 d-flex align-items-center gap-4 flex-wrap">
            ...
            <div class="flex-grow-1" style="min-width: 220px;">
                <h4 class="fw-bold text-white mb-1">Edit Role · {{ $role->name }}</h4>
                <p class="mb-0 text-white-50 fs-14">Update the role details or adjust which permissions it can access.</p>
            </div>
            <div class="d-flex flex-wrap gap-2">
                ...
                <span class="role-hero-chip"><i class="feather-check-circle me-1"></i>{{ $roleSelectedCount }} Assigned</span>
            </div>
        </div>

        <form action="{{ route('admin.roles.update', $role->id) }}" method="POST" class="role-form">
            @csrf
            @method('PUT')
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-icon-wrap">
                                        ...
                                        <input type="text" name="slug" id="slug" class="form-control slug-input @error('slug') is-invalid @enderror" value="{{ old('slug', $role->slug) }}" placeholder="cashier" style="padding-right: 42px;">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-icon-wrap">
                                        ...
                                        <textarea name="description" id="description" rows="3" class="form-control @error('description') is-invalid @enderror" placeholder="A short summary of what this role is responsible for...">{{ old('description', $role->description) }}</textarea>
                                    </div>
                    ...
                    <div class="card role-card h-100">
                        ...
                        <div class="card-body p-4 d-flex flex-column gap-3">
                            ...
                            <div class="help-tip">
                                ...
                                Inactive roles cannot be assigned to new users until re-enabled.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        document.querySelectorAll('form.role-form').forEach(function (form) {
            form.addEventListener('submit', function () {
                ...
                if (btn && !btn.disabled) {
                    ...
                    btn.innerHTML = '<i class="feather-loader spinner me-1 text-white"></i> <span class="text-white">Updating...</span>';
                }
            });
        });
    })();
