...
@section('title', 'Add New Restaurant - Admin Dashboard')
            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input type="checkbox" name="outdoor_seating" id="outdoor_seating" class="form-check-input" value="1" {{ old('outdoor_seating') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input type="checkbox" name="serves_alcohol" id="serves_alcohol" class="form-check-input" value="1" {{ old('serves_alcohol') ? 'checked' : '' }}>
