...
@section('title', 'Add New Restaurant Feature - Admin Dashboard')
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Add New Restaurant Feature</h5>
            </div>
            <ul class="breadcrumb">
    ...
    <div class="main-content">
        ...
        <div class="card stretch stretch-full border-0 shadow-sm rounded-3">
            <div class="card-header border-bottom py-3">
                <h5 class="card-title mb-0 fw-bold">Feature Information</h5>
            </div>
                ...
                <form action="{{ route('admin.restaurant-features.store') }}" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="e.g. Credit card, Wifi, Outdoor seating">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') }}" placeholder="e.g. credit-card, wifi">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="icon" id="icon" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon') }}" placeholder="e.g. feather-wifi, feather-credit-card">
                    ...
                    <div class="d-flex justify-content-end gap-2 border-top pt-4 mt-4">
                        ...
                        <button type="submit" class="btn btn-danger text-white fw-semibold px-4" style="background-color: #cb202d; border: none;">
                            <i class="feather-save me-1"></i> Save Feature
                        </button>
                    </div>
                </form>
            </div>
