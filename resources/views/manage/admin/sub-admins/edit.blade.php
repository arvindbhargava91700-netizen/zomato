...
@section('title', 'Edit Sub Admin - Admin Dashboard')
...
<div class="nxl-content">
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Edit Sub Admin</h5>
            </div>
            <ul class="breadcrumb">
    ...
    <div class="main-content">
        ...
        <div class="role-hero mb-4 d-flex align-items-center gap-3">
            <div class="role-hero-icon"><i class="feather-user"></i></div>
            <div>
                <h4 class="mb-1 fw-bold text-white">Edit Sub Admin</h4>
                <p class="mb-0 opacity-75 fs-13">Update details for <strong>{{ $subAdmin->name }}</strong>.</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.sub-admins.update', $subAdmin->id) }}" method="POST" class="role-form">
            @csrf
            @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $subAdmin->name) }}" placeholder="e.g. Rohan Sharma">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $subAdmin->email) }}" placeholder="rohan@yourcompany.com">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <input type="text" name="mobile" id="mobile" class="form-control @error('mobile') is-invalid @enderror" value="{{ old('mobile', $subAdmin->mobile) }}" placeholder="+91 98765 43210">
                            </div>
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <select name="role_id" id="role_id" class="form-select @error('role_id') is-invalid @enderror">
                                    ...
                                    @foreach($roles as $role)
                                        <option value="{{ $role->slug }}" {{ old('role_id', $subAdmin->role_slug) == $role->slug ? 'selected' : '' }}>{{ $role->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <select name="status" id="status" class="form-select">
                                    <option value="active" {{ old('status', $subAdmin->status) === 'active' ? 'selected' : '' }}>Active</option>
                                    <option value="inactive" {{ old('status', $subAdmin->status) === 'inactive' ? 'selected' : '' }}>Inactive</option>
                                </select>
                            </div>
            ...
            <div class="sticky-bottom bg-white border-top p-3 d-flex align-items-center justify-content-between rounded rounded-top-0 shadow-sm">
                ...
                <div class="d-flex gap-2">
                    ...
                    <button type="submit" class="btn btn-primary px-5 fw-semibold" style="background-color: #cb202d; border: none;">
                        <i class="feather-check me-1"></i> Update Sub Admin
                    </button>
                </div>
            </div>
        </form>
        ...
        document.querySelectorAll('form.role-form').forEach(function (form) {
            form.addEventListener('submit', function () {
                ...
                if (btn && !btn.disabled) {
                    ...
                    btn.innerHTML = '<i class="feather-loader spinner me-1"></i> Updating...';
                }
            });
        });
    })();
