                ...
                <nav class="navbar navbar-expand-lg p-0">
                    ...
                    <div class="nav-option order-md-2">
                        ...
                        <div class="profile-part dropdown-button order-md-2">
                            <img class="img-fluid profile-pic" src="{{ asset('front/assets/images/icons/p5.png') }}" alt="profile">
                            <div>
        ...
        <section class="home-wrapper section-b-space">
            <div class="container text-center">
                <div class="loader-gif">
                    <img src="{{ asset('front/assets/images/gif/food.gif') }}" alt="food-gif" class="img-fluid">
                </div>
