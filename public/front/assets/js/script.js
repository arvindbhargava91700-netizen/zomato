...
themeBtnParent?.addEventListener("click", function (e) {
  ...
  if (!clicked || !rtlBtn || !html || !rtlLink) return;
  if (clicked === "rtl-btn") {
    rtlBtn.id = "ltr-btn";
    var textVal = rtlBtn.querySelector(".text-value");
    if (textVal) textVal.textContent = "LTR";
    html.setAttribute("dir", "rtl");
    rtlLink.href = "front/assets/css/vendors/bootstrap.rtl.css";
    rtlBtn.classList.add("rtlBtnEl");
    localStorage.setItem("rtlcss", "front/assets/css/vendors/bootstrap.rtl.css");
  ...
  if (clicked === "ltr-btn") {
    rtlBtn.id = "rtl-btn";
    var textVal = rtlBtn.querySelector(".text-value");
    if (textVal) textVal.textContent = "RTL";
    html.setAttribute("dir", "");
    rtlLink.href = "front/assets/css/vendors/bootstrap.css";
    localStorage.setItem("rtlcss", "front/assets/css/vendors/bootstrap.css");
...
if (rtlBtn) {
  ...
  var textVal = rtlBtn.querySelector(".text-value");
  if (textVal) {
    textVal.textContent = localStorage.getItem("textContentRtl")
      ? localStorage.getItem("textContentRtl")
      : "RTL";
  }
}
if (html && localStorage.getItem("dir")) {
  html.setAttribute("dir", localStorage.getItem("dir"));
}
if (rtlLink && localStorage.getItem("rtlcss")) {
...
function setLight() {
  ...
  if (container) container.classList.remove("shadow-dark");
...
if (offcanvasCloseBtn) {
  offcanvasCloseBtn.addEventListener("click", function () {
    ...
    if (offcanvasSide) offcanvasSide.classList.remove("show");
  });
}